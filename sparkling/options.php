...
function optionsframework_options() {
		...
		// Layout options
		$site_layout1 = array(
			'col-sm-12 col-md-8 pull-left' => __('75% Content left - Right Sidebar', 'sparkling'),
			'col-sm-12 col-md-8 pull-right' => __('75% Content Right - Left Sidebar', 'sparkling'),
			'full-bleed' => __('100% Full Bleed Content - No Sidebar', 'sparkling'),
		);
		
		$site_layout = array(
			'show yyy' => __('Yes Sidebar', 'sparkling'),
			'hidden zzz' => __('No Sidebar', 'sparkling'),
		);
     ...
     // Pull all the categories into an array
		...
		$options[] = array( 'name' => __('Website Layout Options -  Main Content Area', 'sparkling'),
							'desc' => __('Main content - Choose between 100% full bleed, 25% left or 25% right Main Content areas. Set to full bleed if you want to have no side bar.', 'sparkling'),
							'id' => 'site_layout1',
							'std' => 'col-sm-12 col-md-8 pull-left',
							'type' => 'select',
							'class' => 'mini',
							'options' => $site_layout1);
							
		$options[] = array( 'name' => __('Website Layout Options - Side Bar', 'sparkling'),
							'desc' => __('Side Bar - Choose between Show or Hide sidebar option. Set to hide if you want the main content area to be 100%', 'sparkling'),
							'id' => 'site_layout',
							'std' => 'show',
							'type' => 'select',
							'class' => 'mini',
