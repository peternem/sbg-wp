...
function sparkling_posted_on() {
	...
	printf( '<span class="posted-on"><i class="fa fa-calendar"></i> %1$s</span><span class="byline hidden"> <i class="fa fa-user"></i> %2$s</span>',
		sprintf( '%2$s',
			esc_url( get_permalink() ),
			$time_string
		),
		sprintf( '<span class="author vcard"><a class="url fn n" href="%1$s">Author: %2$s</a></span>',
